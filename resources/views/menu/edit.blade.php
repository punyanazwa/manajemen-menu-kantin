...
<head>
    ...
    <title>Edit Hidangan - Kantin Sekolah</title>
...
<div class="container d-flex justify-content-center">
    <div class="form-container w-100">
        ...
        <div class="header-section">
            <h4 class="form-title">Edit Data Hidangan</h4>
            <p class="text-muted small mb-0">Perbarui informasi menu kuliner kantin Anda dengan benar sesuai standar LKS.</p>
        </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_menu" class="form-control" placeholder="Ayam Goreng Kremes" value="{{ old('nama_menu', $menu->nama_menu) }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="kategori_menu" class="form-select" required>
                            ...
                            <option value="Snack" {{ old('kategori_menu', $menu->kategori_menu) == 'Snack' ? 'selected' : '' }}>Snack</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status_menu" class="form-select" required>
                            ...
                            <option value="Habis" {{ old('status_menu', $menu->status_menu) == 'Habis' ? 'selected' : '' }}>Tidak Tersedia (Habis)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row g-3 mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="number" name="harga" class="form-control" placeholder="15000" min="0" value="{{ old('harga', $menu->harga) }}" required>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label">Stok</label>
                            <input type="number" name="stok" class="form-control" placeholder="20" min="0" value="{{ old('stok', $menu->stok) }}" required>
                        </div>
                    </div>

                    <div class="mb-4">
                        <label class="form-label">Tanggal Input Sistem</label>
                        <input type="date" class="form-control" value="{{ $menu->tanggal_input }}" readonly>
                        <div class="form-text small text-muted mt-2" style="font-weight: 500;">Tanggal awal data dimasukkan ke sistem.</div>
                    </div>

                    <div class="mb-0">
                        <label class="form-label">Deskripsi Kuliner (Opsional)</label>
                        <textarea name="deskripsi" class="form-control" rows="5" placeholder="Tulis deskripsi singkat porsi, rasa, atau racikan hidangan..." style="resize: none;">{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="action-box">
                <div class="row g-3 justify-content-end">
                    ...
                    <div class="col-sm-4 col-6">
                        <button type="submit" class="btn btn-save w-100">Perbarui Menu</button>
                    </div>
                </div>
            </div>
        </form>
