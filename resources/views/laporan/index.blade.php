...
<head>
    ...
    <title>Laporan Daftar Menu - Kantin Sekolah</title>
    ...
    <style>
        ...
        /* Badge Kategori & Status Diperjelas (Sesuai Dashboard) */
        .badge-kategori {
            padding: 8px 14px;
            border-radius: 8px;
            font-size: 0.88rem;
...
<body>
    ...
    <div class="main-content animate-page">
        ...
        <div class="top-profile-bar d-none d-lg-flex">
            <div class="panel-title-text">Halaman Rekapitulasi Laporan</div>
        ...
        <div class="card-table-wrapper">
            <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3 mb-4">
                <div>
                    <h5 class="fw-bold mb-1" style="color: #0f172a;">Laporan Data Keseluruhan Menu</h5>
                    <p class="text-muted mb-0 small">Berikut adalah rekap dokumen resmi seluruh data produk hidangan aktif pada sistem.</p>
                </div>
                <div>
                    <a href="{{ route('laporan.cetak') }}" target="_blank" class="btn btn-print w-100 justify-content-center">
                ...
                <table class="table table-custom align-middle">
                    <thead>
                        <tr>
                            ...
                            <th>Tanggal Input</th>
                            <th class="text-center" style="width: 130px;">Status Ketersediaan</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center text-muted py-5" style="font-weight: 600;">
                                    ...
                                    Tidak ada rekaman data menu kuliner di dalam sistem laporan saat ini.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
